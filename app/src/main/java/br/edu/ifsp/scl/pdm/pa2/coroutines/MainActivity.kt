...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        amb.launchCoroutinesBt.setOnClickListener {
            ...
            val upperText = "Upper before sleep"
            val lowerText = "Lower before sleep"
            ...
            GlobalScope.launch(Dispatchers.Main) {
                ...
                Log.v(
                    ...
                    "Corroutine thread: ${Thread.currentThread().name}, Job: ${coroutineContext[Job]}"
                )
            ...
            Log.v(getString(R.string.app_name), "Corroutine thread: ${Thread.currentThread().name}")
        }
    }
